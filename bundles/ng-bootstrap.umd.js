(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    NgbCarousel.propDecorators = {
        ...
        mouseEnter: [{ type: i0.HostListener, args: ['mouseenter',] }],
        mouseLeave: [{ type: i0.HostListener, args: ['mouseleave',] }]
    };
    ...
    */
    ...
    var NgbPopover = /** @class */ (function () {
        function NgbPopover(_elementRef, _renderer, injector, componentFactoryResolver, viewContainerRef, config, _ngZone, _document, _changeDetector, applicationRef) {
            ...
            this._resizeSubscription = rxjs.fromEvent(window, 'resize').subscribe(function () {
                _this._updated = true;
            });
    ...
    var NgbToast = /** @class */ (function () {
        function NgbToast(ariaLive, config) {
             ...
             * that.
             */
            this.hideOutput = new i0.EventEmitter();
    ...
    NgbToast.propDecorators = {
        ...
        hideOutput: [{ type: i0.Output, args: ['hide',] }]
    };
